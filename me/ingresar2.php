...
<?php include("../includes/navMitica.php");?>
        ...
        <div class="row cuadro-login">
            <div class="col-lg-8 cuador-acciones">
                ...
                <div class="text-center">
                    <h3 class="color-morado pb-4">Diagnostica tu Institución Educativa</h3>
            ...
            <div class="col-lg-4 cuadro-registro">
                <h4 class="pb-1 pt-5">Ingresa a Mítica</h4>
                <p>Registrarse en Mítica es gratuito. Modelo Mitic@: Una propuesta de gestión para la incorporación efectiva de las TIC en instituciones educativas".</p> 
