...
<nav class="navbar navbar-expand-lg navbar-light bg-light color-nav">
    <a class="navbar-brand" href="<?php echo $serverName ?>idea">
        <img src="<?php echo $serverName ?>img/log-eduteka-icesi.png"  
            class="d-inline-block align-top grande" alt="logo IDEA" title="ir al inicio IDEA">
        <img src="<?php echo $serverName ?>img/log-eduteka-icesi-small.png" class="d-inline-block align-top pequeno"
            alt="logo IDEA" title="ir al inicio IDEA">
    </a>
        ...
        <div class="ml-5 ml-small-0">
            ...
            <div class="dropdown dropleft float-right float-right-inverso">
                ...
                <div class="dropdown-menu usuario-opc">
                    ...
                    <a class="dropdown-item" href="<?php echo $serverName?>proyectos/gp"><i
                            class="fa fa-check-square" aria-hidden="true"></i> Mis proyectos</a>
                            
                    <a class="dropdown-item" href="<?php echo $serverName?>proyectos/gp/validador.php"><i
                            class="fa fa-pencil-square-o" aria-hidden="true"></i> Crear Proyecto</a>
            ...
            <?php }else{?>
            <a href="<?php echo $serverName?>me/ingresar.php?o=1" class="btn btn-call-to-action size-nav-btn">Ingresar
            </a>
            <?php }?>
        </div>
