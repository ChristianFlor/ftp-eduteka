...
<nav class="navbar navbar-expand-lg navbar-light bg-light color-nav">
    <a class="navbar-brand" href="<?php echo $serverRubrik ?>">
        <img src="<?php echo $serverName ?>img/log-eduteka-rubrik.png"  
            class="d-inline-block align-top grande" alt="logo Rubrik" title="ir al inicio Rubrik">
        <img src="<?php echo $serverName ?>img/log-eduteka-rubrik.png" class="d-inline-block align-top pequeno"
            alt="logo Rubrik" title="ir al inicio Rubrik">
    </a>
        ...
        <div class="ml-5 ml-small-0">
            ...
            <div class="dropdown dropleft float-right float-right-inverso">
                ...
                <div class="dropdown-menu usuario-opc">
                    ...
                    <a class="dropdown-item" href="<?php echo $serverRubrik?>listado.php"><i
                            class="fa fa-check-square" aria-hidden="true"></i> Mis Rúbricas</a>
                            
                    <a class="dropdown-item" href="<?php echo $serverRubrik?>validador.php"><i
                            class="fa fa-pencil-square-o" aria-hidden="true"></i> Crear Rúbrica</a>
            ...
            <?php }else{?>
            <a href="<?php echo $serverName?>me/ingresar.php?o=2" class="btn btn-call-to-action size-nav-btn">Ingresar
            </a>
            <?php }?>
        </div>
