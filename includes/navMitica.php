...
<nav class="navbar navbar-expand-lg navbar-light bg-light color-nav">
    <a class="navbar-brand" href="<?php echo $serverMitica ?>">
        <img src="<?php echo $serverName ?>img/log-eduteka-mitica.png" 
            class="d-inline-block align-top grande" alt="logo IDEA" title="ir al inicio Mítica">
        <img src="<?php echo $serverName ?>img/log-eduteka-mitica.png" class="d-inline-block align-top pequeno"
            alt="logo Mítica" title="ir al inicio Mítica">
    </a>
    ...
    <div class="collapse navbar-collapse flex-row-reverse" id="navbarNavAltMarkup">
        ...
        <div class="ml-5 ml-small-0">
            ...
            <?php }else{?>
            <a href="<?php echo $serverName?>me/ingresar.php?o=3" class="btn btn-call-to-action size-nav-btn">Ingresar
            </a>
            <?php }?>
        </div>
        ...
        <div class="ml-5 ml-small-0">        
            <div class="dropdown float-right float-right-inverso">
                <a class="" data-toggle="dropdown">         
                    <img src="<?php echo $serverName?>img/appLuancher.svg" width="28"  style="cursor: pointer;">
                </a>
                <div class="dropdown-menu usuario-opc">
        ...
        <div class="navbar-nav">
            ...
            <a class="nav-link ml-sm-0 ml-md-2 ml-lg-3 ml-xl-3 mr-sm-0 mr-md-2 mr-lg-3 mr-xl-3 font-weight-normal <?php echo $estadoDes?>"
                href="<?php echo $serverMitica?>evaluar.php"><span>Diagnosticar</span></a>
            ...
            <?php if(isset($idU)){ ?>
              ...
              <a class="nav-link ml-sm-0 ml-md-2 ml-lg-3 ml-xl-3 mr-sm-0 mr-md-2 mr-lg-3 mr-xl-3 font-weight-normal <?php echo $estadoTut?>"
                href="<?php echo $serverMitica?>perfil.php"><span>Recomendaciones</span></a>
